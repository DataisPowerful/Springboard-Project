...
display(spark.sql("SELECT DISTINCT(marital_status) FROM adult LIMIT 15"))
...
def print_performance_metrics(predictions):
  ...
  # F1
  print("F1 = {}".format(multi_metrics.fMeasure(0.0,2.0)))
  # Precision
  print("Precision = {}".format(multi_metrics.precision(0)))
  # Recall
  print("Recall = {}".format(multi_metrics.recall(0)))
  # FPR
...
rf = RandomForestClassifier(numTrees=100, maxDepth=2, labelCol="label", seed=123)
